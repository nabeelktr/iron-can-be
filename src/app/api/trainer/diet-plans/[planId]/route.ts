...
// GET /api/trainer/diet-plans/[planId] — full plan detail with nested data
...
// PUT /api/trainer/diet-plans/[planId] — update plan metadata and nested days/meals/items
...
// DELETE /api/trainer/diet-plans/[planId] — delete plan and deactivate assignments
